...
module.exports = ( babel, config ) => {
	...
	const buildImport = babel.template(`
		import { getLanguageList, getLanguageReplace, getLanguageControl, registerLanguage, getLanguageString, createTemplateRootDescriptor, getTemplateRootPathArg } from "${ filePath }/language/index.js";
	`);
